<template>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcrumb-text product-more">
                            ...
                            <router-link to="/"><i class="fa fa-home"></i> Home</router-link> <!-- link ke halaman home -->
                            <span>Detail</span>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="product-pic-zoom">
                                    <img class="product-big-img" :src="gambar_default" alt="" /> <!-- v-bind:src="gambar_default" / :src="gambar_default"  terhubung dgn function data di tag script dibwh (data binding)-->
                                </div>
                                <div class="product-thumbs">
                                    <carousel :dots="false" :nav="false" class="product-thumbs-track ps-slider">
                                        <div class="pt" @click="changeImage(thumbs[0])" :class="thumbs[0] == gambar_default ? 'active' : '' "> <!-- event untuk click gambar di slider merubah gambar_default (gambar utama di product)-->
                                            <img src="img/mickey1.jpg" alt="" />
                                        </div>

                                        <div class="pt" @click="changeImage(thumbs[1])" :class="thumbs[1] == gambar_default ? 'active' : '' "> <!-- :class="thumbs[1] == gambar_default ? 'active' : '' "  untuk border saat di click di slider gambar (memberikan class active bila kondisi tsb)-->
  ...
  export default {
    ...
    //function data utk data binding gambar / data dari API
    data() {
        return {
